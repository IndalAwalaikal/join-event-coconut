...
const AdminPendaftaranWebinar = () => {
  ...
  const exportToCSV = () => {
    ...
    link.download = `pendaftaran-webinar-${new Date().toLocaleDateString(
      "id-ID"
    )}.csv`;
    link.click();
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-slate-600">
              Kelola peserta yang mendaftar Webinar
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-slate-200 p-12 text-center">
            ...
            <p className="text-slate-600">
              {searchQuery
                ...
                : "Belum ada peserta yang mendaftar Webinar"}
            </p>
          </div>
        )}
      </div>
...
export default AdminPendaftaranWebinar;
